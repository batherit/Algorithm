...
const char ccPlayerSaveFileDirectory[ciFileNameSize] = "../SaveFile/PlayerInfo";

// 키에 대응하는 값은 1부터 시작
enum E_CLASS { 
	CLASS_WARRIOR = 1, CLASS_WIZARD, CLASS_THIEF, CLASS_EOF 
};
enum E_BEHAVIOR	{ 
	BEHAVIOR_BATTLE = 1, BEHAVIOR_RUN, BEHAVIOR_EOF 
};
enum E_DIFFICULTY { 
	DIF_LOW, DIF_MIDDLE, DIF_HIGH, DIF_EOF 
};
enum E_MENU { 
	MENU_LOW = 1, MENU_MIDDLE, MENU_HIGH, MENU_EXIT, MENU_EOF 
};
